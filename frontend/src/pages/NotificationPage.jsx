...
const NotificationPage = () => {
  ...
  const incomingFriendRequests = friendRequests?.incomingRequests || []
                  ...
                  <section>
                    ...
                    <div className='space-y-3'>
                      {incomingFriendRequests.map((request) => (
                        <div key={request._id} className='card bg-base-200 shadow-sm hove:shadow-md transition-shadow'>
...
{/* ACCEPTED REQS NOTIFICATONS */}
  ...
  <img src={notification?.receiver?.profilePic} alt={notification?.receiver?.fullName || 'User'} />
</div>
    ...
    {incomingFriendRequests.length === 0 && acceptedRequests.length === 0 && (
